...
{
    public partial class NorthwindConsole_32_PAKContext : DbContext
    {
        public NorthwindConsole_32_PAKContext()
        {
        }

        public NorthwindConsole_32_PAKContext(DbContextOptions<NorthwindConsole_32_PAKContext> options)
            : base(options)
        {
        }
